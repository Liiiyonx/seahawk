  ...
  <div class="login">
    <div class="login__card panel">
      ...
      <details class="login__demo">
        <summary>演示账号（点击展开）</summary>
        <table class="login__demo-table">
          <tbody>
            <tr><td>admin / admin123456</td><td>系统管理员 · 全部权限</td></tr>
            <tr><td>operator / operator123456</td><td>乡镇操作员 · 本辖区写权限</td></tr>
            <tr><td>viewer / viewer123456</td><td>访客 · 只读大屏</td></tr>
          </tbody>
        </table>
      </details>
    </div>
